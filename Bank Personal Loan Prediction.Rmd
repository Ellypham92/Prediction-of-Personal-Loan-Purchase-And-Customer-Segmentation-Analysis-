---
title: "Prediction of Personal Loan Purchase Customer Segmentation Analysis"
output: "Display the values in the console"
---

```{r}
#1. Read-in the data ("Bank_Personal_Loan_Modelling.csv").
personal_loan <- read.csv("~/Desktop/cs5310/project/data/Bank_Personal_Loan_Original.csv")
```
...
hist(personal_loan$Age, col = 'deeppink3')
# Observation: 
